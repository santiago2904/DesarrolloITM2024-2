        ...
        while (true)
        {
            ...
            switch (option)
            {
                case "1":
                    ...
                    _vendedorService.CreateVendedor(email, nombre, apellido, direccion, carne);
                ...
                case "3":
                    ...
                    _vendedorService.UpdateVendedor(codigoVendedor, nuevoEmail, nuevoNombre, nuevoApellido, nuevoDireccion,
                        nuevoCarne);
                    break;
                case "4":
                    Console.WriteLine("Ingrese el código del vendedor a eliminar:");
                    int codigoEliminarVendedor = int.Parse(Console.ReadLine());
                    _vendedorService.DeleteCliente(codigoEliminarVendedor);
                    break;
                case "5":
                    return;
                default:
